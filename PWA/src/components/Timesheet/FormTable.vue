<template>
  <v-data-table class="elevation-1" :headers="headers" :items="allEntries">
              ...
              <v-container>
                ...
                >
                  ...
                  >
                    <!-- Cancel/Save panel -->
                    <v-spacer></v-spacer>
                    <v-btn text color="primary" @click="openStartTime = false">
                      Cancel
                    </v-btn>
                    <v-btn
                      text
                ...
                >
                  ...
                  >
                    <!-- Cancel/Save Panel -->
                    <v-spacer></v-spacer>
                    <v-btn text color="primary" @click="openEndTime = false">
                      Cancel
                    </v-btn>
                    <v-btn
                      text
    ...
    <template v-slot:no-data>
      <v-btn color="red" @click="initialize">
        Reset
      </v-btn>
    </template>
  </v-data-table>
...
<script>
  export default {
    ...
    data: function () {
      return {
        colNames: ["date", "startTime", "endTime", "totalHours", "group"],
        headers: [
